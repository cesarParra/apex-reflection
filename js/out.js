...
(function dartProgram() {
  ...
  var A = {
      ...
      NoViableAltException$(recognizer, input, startToken, offendingToken, deadEndConfigs, ctx) {
        var t1 = input == null ? recognizer._parser$_input : input,
          t2 = startToken == null ? recognizer._parser$_input.LT$1(1) : startToken,
          t3 = offendingToken == null ? recognizer._parser$_input.LT$1(1) : offendingToken;
      ...
      InputMismatchException$(recognizer, state, ctx) {
        var t1 = recognizer._parser$_input,
          t2 = ctx == null,
      ...
      FailedPredicateException$(recognizer, predicate) {
        ...
        t1.offendingToken = recognizer._parser$_input.LT$1(1);
        return t1;
      },
    ...
    F = {
      ...
      Method_toJson_closure: function Method_toJson_closure() {
      },
      ...
      Constructor_toJson_closure: function Constructor_toJson_closure() {
      },
    ...
    G = {
      Parser: function Parser() {
      ...
      }, ClassModel_toJson_closure: function ClassModel_toJson_closure() {
      }, ClassModel_toJson_closure0: function ClassModel_toJson_closure0() {
      }, ClassModel_toJson_closure1: function ClassModel_toJson_closure1() {
      }, ClassModel_toJson_closure2: function ClassModel_toJson_closure2() {
      }, ClassModel_toJson_closure3: function ClassModel_toJson_closure3() {
      }, ClassModel_toJson_closure4: function ClassModel_toJson_closure4() {
      }, ClassModel_toJson_closure5: function ClassModel_toJson_closure5() {
        ...
        _.DocsCommentAwareness_rawDocComment = t4;
        _.AccessModifierAwareness_accessModifiers = t5;
      }, InterfaceModel_toJson_closure: function InterfaceModel_toJson_closure() {
    ...
    H = {
      ...
      Primitives__generalApplyFunction($function, positionalArguments, namedArguments) {
        var $arguments, argumentCount, requiredParameterCount, defaultValuesClosure, t1, defaultValues, interceptor,
          jsFunction, maxArguments, missingDefaults, keys, _i, defaultValue, used, key;
      ...
      _unwrapNonDartException(ex) {
        var message, number, ieErrorCode, t1, nsme, notClosure, nullCall, nullLiteralCall, undefCall, undefLiteralCall,
          nullProperty, undefProperty, undefLiteralProperty, match, _null = null;
        if (!("message" in ex))
          return ex;
        message = ex.message;
      ...
      _substitute(universe, rti, typeArguments, depth) {
        var baseType, substitutedBaseType, interfaceTypeArguments, substitutedInterfaceTypeArguments, base,
          substitutedBase, $arguments, substitutedArguments, returnType, substitutedReturnType, functionParameters,
          substitutedFunctionParameters, bounds, substitutedBounds, index, argument,
          kind = rti._kind;
        switch (kind) {
          case 5:
          case 1:
      ...
      _functionRtiToString(functionType, genericContext, bounds) {
        var boundsLength, outerContextLength, offset, i, t1, t2, t3, typeParametersText, typeSep, t4, t5, boundRti,
          kind, parameters, requiredPositional, requiredPositionalLength, optionalPositional, optionalPositionalLength,
          named, namedLength, returnTypeText, argumentsText, sep, _s2_ = ", ";
        if (bounds != null) {
      ...
      _isFunctionSubtype(universe, s, sEnv, t, tEnv) {
        var sParameters, tParameters, sRequiredPositional, tRequiredPositional, sRequiredPositionalLength,
          tRequiredPositionalLength, requiredPositionalDelta, sOptionalPositional, tOptionalPositional,
          sOptionalPositionalLength, tOptionalPositionalLength, i, t1, sNamed, tNamed, sNamedLength, tNamedLength,
          sIndex, tIndex, tName, sName;
    ...
    R = {
      ATN: function ATN(t0, t1, t2, t3, t4, t5) {
        var _ = this;
        _.states = t0;
      ...
      ApexLexer: function ApexLexer(t0, t1, t2, t3, t4, t5, t6) {
        ...
        _.modeNames = t1;
        _.ruleNames = t2;
        _._tokenFactorySourcePair = _._input = null;
        _.tokenFactory = t3;
        _._token = null;
    ...
    S = {
      ...
      IntervalSet_subtract(left, right) {
        var result, resultI, rightI, t2, resultInterval, rightInterval, t3, t4, t5, beforeCurrent, afterCurrent,
          resultI0,
    ...
    T = {
      LexerActionType: function LexerActionType(t0, t1) {
        this.index = t0;
      ...
      PredictionContext_mergeArrays(a, b, rootIsWildcard, mergeCache) {
        var t2, previous, t3, t4, mergedReturnStates, t5, t6, mergedParents, i, j, k, t7, t8, a_parent, b_parent,
          payload, both$, ax_ax, p, a_, mergedParents0, mergedReturnStates0, $M,
          t1 = mergeCache != null;
        if (t1) {
    ...
    U = {
      StateType: function StateType(t0) {
    ...
    X = {
      CommonTokenFactory: function CommonTokenFactory() {
      },
    ...
    Y = {
      DFASerializer: function DFASerializer(t0, t1) {
        this.dfa = t0;
        this.vocabulary = t1;
  ...
  P._BigIntImpl.prototype = {
    ...
    _divRem$1(other) {
      var yDigits, yUsed, t1, nsh, yDigits0, yUsed0, resultDigits, resultUsed0, topDigitDivisor, j, tmpDigits, tmpUsed,
        resultUsed1, t2, nyDigits, i, estimatedQuotientDigit, _this = this,
  ...
  A.ATNDeserializer.prototype = {
    ...
    readEdges$2(atn, sets) {
      var t1, t2, i, t3, t4, t5, t6, t7, ttype, t8, t9, trans, srcState, _i, t, outermostPrecedenceReturn, state,
        target, _this = this,
    ...
    readLexerActions$1(atn) {
      var t1, t2, i, actionType, t3, t4, data1, data2, lexerAction, legacyLexerActions, _i, transition, ruleIndex, t5,
        _this = this;
  ...
  E.LexerATNSimulator.prototype = {
    ...
    getReachableConfigSet$4(input, configs, reach, t) {
      var t1, treatEofAsEpsilon, t2, t3, skipAlt, t4, currentAltReachedAcceptState, n, ti, t5, target,
        lexerActionExecutor, _this = this;
    ...
    closure$6(input, config, configs, currentAltReachedAcceptState, speculative, treatEofAsEpsilon) {
      ...
      if (t2 instanceof U.RuleStopState) {
        P.log("closure at " + C.JSArray_methods.$index(t1.ruleNames, t2.ruleIndex) + " rule stop " + config.toString$0(0) + "\n", 500);
        t1 = config.context;
      ...
      for (t1 = config.state.transitions, t2 = _this.atn, t3 = type$.legacy_ActionTransition, t4 = type$.legacy_PredicateTransition, t5 = type$.legacy_RuleTransition, i = 0; i < t1.length; ++i) {
        ...
        switch (t.get$type(t)) {
          ...
          case C.TransitionType_4:
            ...
            H.boolConversionCheck(_this.evaluatePredicate$4(input, t6, t7, speculative));
    ...
    evaluatePredicate$4(input, ruleIndex, predIndex, speculative) {
      var savedCharPositionInLine, savedLine, index, marker, _this = this;
      if (!speculative)
        return true;
  ...
  S.ParserATNSimulator.prototype = {
    ...
    computeReachSet$3(config, t, fullCtx) {
      var intermediate, t1, t2, t3, t4, skippedStopStates, t5, t6, n, ti, target, reach, closureBusy, _i, _this = this,
        _null = null;
  ...
  M.DefaultErrorStrategy.prototype = {
    reportError$2(recognizer, e) {
      ...
      if (e instanceof A.NoViableAltException) {
        tokens = recognizer._parser$_input;
        if (tokens != null) {
          t1 = e.startToken;
        ...
        recognizer.notifyErrorListeners$3("mismatched input " + _this.getTokenErrorDisplay$1(e.offendingToken) + " expecting " + J.toString$1$vocabulary$(e.get$expectedTokens(), $.$get$ApexParser_VOCABULARY()), e.offendingToken, e);
      else if (e instanceof A.FailedPredicateException) {
        t1 = recognizer.ruleNames;
    ...
    recover$2(recognizer, e) {
      var t1, _this = this;
      if (_this.lastErrorIndex === recognizer._parser$_input.p) {
      ...
      _this.lastErrorIndex = recognizer._parser$_input.p;
      t1 = _this.lastErrorStates;
      if (t1 == null)
    ...
    sync$1(recognizer) {
      var la, t1, nextTokens, expecting, o, _this = this,
        s = C.JSArray_methods.$index(recognizer.interpreter.atn.states, recognizer._stateNumber);
      if (_this.errorRecoveryMode)
        return;
      la = recognizer._parser$_input.LT$1(1).type;
      t1 = $.$get$ApexParser__ATN();
      nextTokens = t1.nextTokens$1(s);
      ...
      switch (s.get$stateType()) {
        ...
        case C.StateType_9:
          ...
          expecting = t1.getExpectedTokens$2(recognizer._stateNumber, recognizer._ctx);
    ...
    reportUnwantedToken$1(recognizer) {
      ...
      t = recognizer._parser$_input.LT$1(1);
      tokenName = this.getTokenErrorDisplay$1(t);
      expecting = $.$get$ApexParser__ATN().getExpectedTokens$2(recognizer._stateNumber, recognizer._ctx);
      recognizer.notifyErrorListeners$3("extraneous input " + tokenName + " expecting " + expecting.toString$1$vocabulary(0, $.$get$ApexParser_VOCABULARY()), t, null);
    },
    reportMissingToken$1(recognizer) {
      ...
      this.errorRecoveryMode = true;
      t = recognizer._parser$_input.LT$1(1);
      recognizer.notifyErrorListeners$3("missing " + $.$get$ApexParser__ATN().getExpectedTokens$2(recognizer._stateNumber, recognizer._ctx).toString$1$vocabulary(0, $.$get$ApexParser_VOCABULARY()) + " at " + this.getTokenErrorDisplay$1(t), t, null);
    },
    recoverInline$1(recognizer) {
      ...
      if (_this.singleTokenInsertion$1(recognizer)) {
        currentSymbol = recognizer._parser$_input.LT$1(1);
        expecting = $.$get$ApexParser__ATN().getExpectedTokens$2(recognizer._stateNumber, recognizer._ctx);
        t1 = expecting.intervals.length;
        expectedTokenType = t1 !== 0 ? expecting.get$minElement() : 0;
        tokenText = expectedTokenType === -1 ? "<missing EOF>" : "<missing " + $.$get$ApexParser_VOCABULARY().getDisplayName$1(expectedTokenType) + ">";
        lookback = recognizer._parser$_input.LT$1(-1);
        current = currentSymbol.type === -1 && lookback != null ? lookback : currentSymbol;
        t1 = recognizer._parser$_input._tokenSource;
        t2 = current.source.a;
        return t1.tokenFactory.create$8(expectedTokenType, tokenText, new V.Pair(t2, t2._input, type$.Pair_of_legacy_TokenSource_and_legacy_CharStream), 0, -1, -1, current.line, current.charPositionInLine);
      }
    ...
    singleTokenInsertion$1(recognizer) {
      var next,
        currentSymbolType = recognizer._parser$_input.LT$1(1).type,
    ...
    singleTokenDeletion$1(recognizer) {
      var matchedSymbol, _this = this,
        nextTokenType = recognizer._parser$_input.LT$1(2).type;
      if ($.$get$ApexParser__ATN().getExpectedTokens$2(recognizer._stateNumber, recognizer._ctx).contains$1(0, nextTokenType)) {
        _this.reportUnwantedToken$1(recognizer);
        recognizer.consume$0();
        matchedSymbol = recognizer._parser$_input.LT$1(1);
    ...
    consumeUntil$2(recognizer, set) {
      var ttype = recognizer._parser$_input.LT$1(1).type;
      while (true) {
        if (!(ttype !== -1 && !set.contains$1(0, ttype)))
          break;
        recognizer.consume$0();
        ttype = recognizer._parser$_input.LT$1(1).type;
      }
    },
    $isErrorStrategy: 1
  };
        ...
        $label0$0:
          for (t1 = type$.legacy_RecognitionException, t2 = type$.legacy_LexerNoViableAltException, t3 = _this._listeners; true;) {
            if (_this._hitEOF) {
              ...
              t3 = _this._input._input_stream$_index;
            ...
            _this._token = null;
            _this.channel = 0;
            _this.tokenStartCharIndex = _this._input._input_stream$_index;
            ...
            do {
              ...
              ttype = null;
              try {
                ttype = _this.interpreter.match$2(_this._input, _this.mode_);
              } catch (exception) {
                ...
                if (t4 instanceof A.LexerNoViableAltException) {
                  ...
                  if (t1._as(e) instanceof A.LexerNoViableAltException) {
                    if (_this._input.LA$1(1) !== -1)
                      _this.interpreter.consume$1(_this._input);
                  } else {
                    t4 = _this._input;
            ...
            t1 = _this._token;
            if (t1 == null)
              t1 = _this._token = _this.tokenFactory.create$8(t4, _this._text, _this._tokenFactorySourcePair, _this.channel, _this.tokenStartCharIndex, _this._input._input_stream$_index - 1, _this.tokenStartLine, _this.tokenStartCharPositionInLine);
            return t1;
          }
      } finally {
  ...
  G.Parser.prototype = {
    ...
    triggerExitRuleEvent$0() {
      ...
      for (i = _this._parseListeners.length - 1; i >= 0; --i) {
        ...
        t1 = listener.parser;
        t2 = t1.ruleNames;
        t3 = _this._ctx.get$ruleIndex();
        if (t3 < 0 || t3 >= 89)
          return H.ioore(t2, t3);
        C.JSString_methods.$add("exit    " + t2[t3] + ", LT(1)=", t1._parser$_input.LT$1(1).get$text());
      }
    },
    notifyErrorListeners$3(msg, offendingToken, e) {
      var line, charPositionInLine, _this = this;
      if (offendingToken == null)
        offendingToken = _this._parser$_input.LT$1(1);
      ++_this._syntaxErrors;
    ...
    consume$0() {
      var t1, t2, t3, _i, _this = this,
        o = _this._parser$_input.LT$1(1);
      if (o.type !== -1)
        _this._parser$_input.consume$0();
    ...
    enterRule$3(localctx, state, ruleIndex) {
      ...
      _this._ctx = localctx;
      localctx.start = _this._parser$_input.LT$1(1);
      t1 = _this._ctx;
      t1.toString;
      t2 = type$.legacy_ParserRuleContext;
    ...
    pushNewRecursionContext$3(localctx, state, ruleIndex) {
      ...
      previous.stop = _this._parser$_input.LT$1(-1);
      _this._ctx = localctx;
    ...
    unrollRecursionContexts$1(_parentctx) {
      ...
      if (0 >= t1.length)
        return H.ioore(t1, -1);
      t1.pop();
      _this._ctx.stop = _this._parser$_input.LT$1(-1);
      retctx = _this._ctx;
      if (_this._parseListeners != null)
  ...
  E.RuleContext.prototype = {
    ...
    toString$1$recog(_, recog) {
      ...
      type$.legacy_Recognizer_legacy_ATNSimulator._as(recog);
      ruleNames = recog == null ? null : recog.ruleNames;
      buf = new P.StringBuffer("");
      buf._contents = "[";
      t1 = type$.legacy_ParserRuleContext;
      t2 = ruleNames == null;
  ...
  U.main_closure.prototype = {
    call$1(declarationBody) {
      var input, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, lexer, parser, tree;
  ...
  R.ApexParser.prototype = {
    ...
    typeDeclaration$0() {
      ...
      try {
        ...
        t2.sync$1(_this);
        switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 7, _this._ctx)) {
          case 1:
            ...
            t2.sync$1(_this);
            _la = _this._parser$_input.LT$1(1).type;
            if (J.$eq$(_la, 110)) {
    ...
    classBodyDeclaration$0() {
      ...
      try {
        ...
        t2 = _this.errorHandler;
        t2.sync$1(_this);
        switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 19, _this._ctx)) {
          case 1:
          ...
          case 3:
            ...
            t2.sync$1(_this);
            _alt = _this.interpreter.adaptivePredict$3(_this._parser$_input, 18, _this._ctx);
            while (true) {
    ...
    modifier$0() {
      ...
      try {
        ...
        _this.errorHandler.sync$1(_this);
        switch (_this._parser$_input.LT$1(1).type) {
          case 108:
            _this.enterOuterAlt$2(_localctx, 1);
    ...
    memberDeclaration$0() {
      ...
      try {
        ...
        _this.errorHandler.sync$1(_this);
        switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 21, _this._ctx)) {
          case 1:
    ...
    interfaceMethodDeclaration$0() {
      ...
      try {
        ...
        t1.sync$1(_this);
        _alt = _this.interpreter.adaptivePredict$3(_this._parser$_input, 26, _this._ctx);
        while (true) {
          if (!(!J.$eq$(_alt, 2) && !J.$eq$(_alt, 0)))
            break;
          if (J.$eq$(_alt, 1)) {
    ...
    arrayInitializer$0() {
      ...
      try {
        ...
        if (t2) {
          ...
          t1.sync$1(_this);
          _alt = _this.interpreter.adaptivePredict$3(_this._parser$_input, 30, _this._ctx);
          while (true) {
            if (!(!J.$eq$(_alt, 2) && !J.$eq$(_alt, 0)))
              break;
            if (J.$eq$(_alt, 1)) {
    ...
    typeRef$0() {
      ...
      try {
        ...
        t1 = _this.errorHandler;
        t1.sync$1(_this);
        _alt = _this.interpreter.adaptivePredict$3(_this._parser$_input, 33, _this._ctx);
        while (true) {
          if (!(!J.$eq$(_alt, 2) && !J.$eq$(_alt, 0)))
            break;
          if (J.$eq$(_alt, 1)) {
    ...
    arraySubscripts$0() {
      ...
      try {
        ...
        t1 = _this.errorHandler;
        t1.sync$1(_this);
        _alt = _this.interpreter.adaptivePredict$3(_this._parser$_input, 34, _this._ctx);
        while (true) {
          if (!(!J.$eq$(_alt, 2) && !J.$eq$(_alt, 0)))
            break;
          if (J.$eq$(_alt, 1)) {
    ...
    typeName$0() {
      ...
      try {
        ...
        t1 = _this.errorHandler;
        t1.sync$1(_this);
        switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 39, _this._ctx)) {
          case 1:
            _this.enterOuterAlt$2(_localctx, 1);
            ...
            t1.sync$1(_this);
            switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 35, _this._ctx)) {
              case 1:
          ...
          case 2:
            ...
            t1.sync$1(_this);
            switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 36, _this._ctx)) {
              case 1:
          ...
          case 3:
            ...
            t1.sync$1(_this);
            switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 37, _this._ctx)) {
              case 1:
          ...
          case 4:
            ...
            t1.sync$1(_this);
            switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 38, _this._ctx)) {
              case 1:
    ...
    formalParameter$0() {
      ...
      try {
        ...
        t1 = _this.errorHandler;
        t1.sync$1(_this);
        _alt = _this.interpreter.adaptivePredict$3(_this._parser$_input, 42, _this._ctx);
        while (true) {
          if (!(!J.$eq$(_alt, 2) && !J.$eq$(_alt, 0)))
            break;
          if (J.$eq$(_alt, 1)) {
    ...
    literal$0() {
      ...
      try {
        ...
        if (!t1)
          ...
          if (_this._parser$_input.LT$1(1).type === -1)
            _this.matchedEOF = true;
          t1 = _this.errorHandler;
          t1.errorRecoveryMode = false;
          t1.lastErrorStates = null;
    ...
    annotation$0() {
      ...
      try {
        ...
        if (J.$eq$(_la, 62)) {
          ...
          t1.sync$1(_this);
          switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 44, _this._ctx)) {
            case 1:
    ...
    elementValueArrayInitializer$0() {
      ...
      try {
        ...
        if (t2) {
          ...
          t1.sync$1(_this);
          _alt = _this.interpreter.adaptivePredict$3(_this._parser$_input, 49, _this._ctx);
          while (true) {
            if (!(!J.$eq$(_alt, 2) && !J.$eq$(_alt, 0)))
              break;
            if (J.$eq$(_alt, 1)) {
    ...
    localVariableDeclaration$0() {
      ...
      try {
        ...
        t1 = _this.errorHandler;
        t1.sync$1(_this);
        _alt = _this.interpreter.adaptivePredict$3(_this._parser$_input, 53, _this._ctx);
        while (true) {
          if (!(!J.$eq$(_alt, 2) && !J.$eq$(_alt, 0)))
            break;
          if (J.$eq$(_alt, 1)) {
    ...
    statement$0() {
      ...
      try {
        ...
        _this.errorHandler.sync$1(_this);
        switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 54, _this._ctx)) {
          case 1:
            _this.enterOuterAlt$2(_localctx, 1);
    ...
    ifStatement$0() {
      ...
      try {
        ...
        _this.errorHandler.sync$1(_this);
        switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 55, _this._ctx)) {
          case 1:
    ...
    whenValue$0() {
      ...
      try {
        ...
        t1 = _this.errorHandler;
        t1.sync$1(_this);
        switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 58, _this._ctx)) {
          case 1:
            _this.enterOuterAlt$2(_localctx, 1);
    ...
    catchClause$0() {
      ...
      try {
        ...
        t1 = _this.errorHandler;
        t1.sync$1(_this);
        _alt = _this.interpreter.adaptivePredict$3(_this._parser$_input, 71, _this._ctx);
        while (true) {
          if (!(!J.$eq$(_alt, 2) && !J.$eq$(_alt, 0)))
            break;
          if (J.$eq$(_alt, 1)) {
    ...
    forControl$0() {
      ...
      try {
        ...
        t1 = _this.errorHandler;
        t1.sync$1(_this);
        switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 75, _this._ctx)) {
          case 1:
            _this.enterOuterAlt$2(_localctx, 1);
    ...
    forInit$0() {
      ...
      try {
        ...
        _this.errorHandler.sync$1(_this);
        switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 76, _this._ctx)) {
          case 1:
            _this.enterOuterAlt$2(_localctx, 1);
    ...
    expression$1(_p) {
      ...
      _this._ctx = t2;
      t2.start = _this._parser$_input.LT$1(1);
      if (_this._parseListeners != null)
        _this.triggerEnterRuleEvent$0();
      _la = null;
      try {
        ...
        t2 = _this.errorHandler;
        t2.sync$1(_this);
        switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 78, _this._ctx)) {
          case 1:
        ...
        t2.sync$1(_this);
        _alt = _this.interpreter.adaptivePredict$3(_this._parser$_input, 83, _this._ctx);
        while (true) {
          if (!(!J.$eq$(_alt, 2) && !J.$eq$(_alt, 0)))
            break;
          if (J.$eq$(_alt, 1)) {
            ...
            t2.sync$1(_this);
            switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 82, _this._ctx)) {
              case 1:
                t4 = _parentState;
              ...
              case 3:
                ...
                t2.sync$1(_this);
                switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 79, _this._ctx)) {
                  case 1:
              ...
              case 13:
                ...
                t2.sync$1(_this);
                switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 81, _this._ctx)) {
                  case 1:
    ...
    primary$0() {
      ...
      try {
        ...
        _this.errorHandler.sync$1(_this);
        switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 84, _this._ctx)) {
          case 1:
    ...
    creator$0() {
      ...
      try {
        ...
        _this.errorHandler.sync$1(_this);
        switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 90, _this._ctx)) {
          case 1:
    ...
    arrayCreatorRest$0() {
      ...
      try {
        ...
        t1 = _this.errorHandler;
        t1.sync$1(_this);
        switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 94, _this._ctx)) {
          case 1:
            _this.enterOuterAlt$2(_localctx, 1);
          ...
          case 2:
            ...
            t1.sync$1(_this);
            switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 93, _this._ctx)) {
              case 1:
    ...
    soqlLiteral$0() {
      ...
      try {
        ...
        t1 = _this.errorHandler;
        t1.sync$1(_this);
        _alt = _this.interpreter.adaptivePredict$3(_this._parser$_input, 99, _this._ctx);
        while (true) {
          ...
          if (J.$eq$(_alt, 2)) {
            ...
            t1.sync$1(_this);
            switch (_this.interpreter.adaptivePredict$3(_this._parser$_input, 98, _this._ctx)) {
              case 1:
  ...
  R.ConstructorDeclarationContext.prototype = {
    ...
    enterRule$1(listener) {
      ...
      if (type$.ApexParserListener._is(listener)) {
        ...
        constructorGenerated.set$accessModifiers(type$.List_String._as(t2));
  ...
  Z.ApexParserBaseListener.prototype = {$isParseTreeListener: 1, $isApexParserListener: 1};
  ...
  F.Property.prototype = {
    toJson$0() {
      return P.LinkedHashMap_LinkedHashMap$_literal(["name", this.name, "type", this.type, "access_modifiers", this.AccessModifierAwareness_accessModifiers], type$.String, type$.dynamic);
    }
  };
  F.Field.prototype = {
    toJson$0() {
  ...
  F.Method.prototype = {
    toJson$0() {
      var _this = this,
        ...
        t2 = J.map$1$1$ax(_this.ParameterAwareness__parameters, new F.Method_toJson_closure(), type$.Map_String_dynamic);
      return P.LinkedHashMap_LinkedHashMap$_literal(["name", _this.name, "type", _this.type, "access_modifiers", t1, "parameters", P.List_List$of(t2, true, t2.$ti._eval$1("ListIterable.E"))], type$.String, type$.dynamic);
    }
  };
  F.Method_toJson_closure.prototype = {
    call$1(e) {
      return type$.Parameter._as(e).toJson$0();
    },
    $signature: 9
  };
  ...
  F.Constructor.prototype = {
    toJson$0() {
      var t1 = this.AccessModifierAwareness_accessModifiers,
        t2 = J.map$1$1$ax(this.ParameterAwareness__parameters, new F.Constructor_toJson_closure(), type$.Map_String_dynamic);
      return P.LinkedHashMap_LinkedHashMap$_literal(["access_modifiers", t1, "parameters", P.List_List$of(t2, true, t2.$ti._eval$1("ListIterable.E"))], type$.String, type$.dynamic);
    }
  };
  F.Constructor_toJson_closure.prototype = {
    call$1(e) {
      return type$.Parameter._as(e).toJson$0();
    },
    $signature: 9
  ...
  G.ClassModel.prototype = {
    ...
    toJson$0() {
      var t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23,
        _this = this,
        t1 = _this.__ClassModel_extendedClass;
      if (t1 === $)
        t1 = H.throwExpression(H.LateError$fieldNI("extendedClass"));
      t2 = _this.__ClassModel_implementedInterfaces;
      if (t2 === $)
        t2 = H.throwExpression(H.LateError$fieldNI("implementedInterfaces"));
      t3 = _this.fields;
      t4 = H._arrayInstanceType(t3);
      t5 = t4._eval$1("MappedListIterable<1,Map<String,@>>");
      t6 = _this.constructors;
      t7 = H._arrayInstanceType(t6);
      t8 = t7._eval$1("MappedListIterable<1,Map<String,@>>");
      t9 = _this.properties;
      t10 = H._arrayInstanceType(t9);
      t11 = t10._eval$1("MappedListIterable<1,Map<String,@>>");
      t12 = _this.MethodsAwareness_methods;
      t13 = H._arrayInstanceType(t12);
      t14 = t13._eval$1("MappedListIterable<1,Map<String,@>>");
      t15 = _this.interfaces;
      t16 = H._arrayInstanceType(t15);
      t17 = t16._eval$1("MappedListIterable<1,Map<String,@>>");
      t18 = _this.enums;
      t19 = H._arrayInstanceType(t18);
      t20 = t19._eval$1("MappedListIterable<1,Map<String,@>>");
      t21 = _this.classes;
      t22 = H._arrayInstanceType(t21);
      t23 = t22._eval$1("MappedListIterable<1,Map<String,@>>");
      return P.LinkedHashMap_LinkedHashMap$_literal(["name", _this.name, "extended_class", t1, "implemented_interfaces", t2, "access_modifiers", _this.AccessModifierAwareness_accessModifiers, "fields", P.List_List$of(new H.MappedListIterable(t3, t4._eval$1("Map<String,@>(1)")._as(new G.ClassModel_toJson_closure()), t5), true, t5._eval$1("ListIterable.E")), "constructors", P.List_List$of(new H.MappedListIterable(t6, t7._eval$1("Map<String,@>(1)")._as(new G.ClassModel_toJson_closure0()), t8), true, t8._eval$1("ListIterable.E")), "properties", P.List_List$of(new H.MappedListIterable(t9, t10._eval$1("Map<String,@>(1)")._as(new G.ClassModel_toJson_closure1()), t11), true, t11._eval$1("ListIterable.E")), "methods", P.List_List$of(new H.MappedListIterable(t12, t13._eval$1("Map<String,@>(1)")._as(new G.ClassModel_toJson_closure2()), t14), true, t14._eval$1("ListIterable.E")), "interfaces", P.List_List$of(new H.MappedListIterable(t15, t16._eval$1("Map<String,@>(1)")._as(new G.ClassModel_toJson_closure3()), t17), true, t17._eval$1("ListIterable.E")), "enums", P.List_List$of(new H.MappedListIterable(t18, t19._eval$1("Map<String,@>(1)")._as(new G.ClassModel_toJson_closure4()), t20), true, t20._eval$1("ListIterable.E")), "classes", P.List_List$of(new H.MappedListIterable(t21, t22._eval$1("Map<String,@>(1)")._as(new G.ClassModel_toJson_closure5()), t23), true, t23._eval$1("ListIterable.E")), "type", "class"], type$.String, type$.dynamic);
    }
  };
  G.ClassModel_toJson_closure.prototype = {
    call$1(e) {
      return type$.Field._as(e).toJson$0();
    },
    $signature: 20
  };
  G.ClassModel_toJson_closure0.prototype = {
    call$1(e) {
      return type$.Constructor._as(e).toJson$0();
    },
    $signature: 21
  };
  G.ClassModel_toJson_closure1.prototype = {
    call$1(e) {
      return type$.Property._as(e).toJson$0();
    },
    $signature: 34
  };
  G.ClassModel_toJson_closure2.prototype = {
    call$1(e) {
      return type$.Method._as(e).toJson$0();
    },
    $signature: 10
  };
  G.ClassModel_toJson_closure3.prototype = {
    call$1(e) {
      return type$.InterfaceModel._as(e).toJson$0();
    },
    $signature: 24
  };
  G.ClassModel_toJson_closure4.prototype = {
    call$1(e) {
      return type$.EnumModel._as(e).toJson$0();
    },
    $signature: 25
  };
  G.ClassModel_toJson_closure5.prototype = {
    call$1(e) {
      return type$.ClassModel._as(e).toJson$0();
    },
    $signature: 26
  };
  G.InterfaceModel.prototype = {
    toJson$0() {
      var t2, t3, t4, _this = this,
        t1 = _this.__InterfaceModel_extendedInterfaces;
      if (t1 === $)
        t1 = H.throwExpression(H.LateError$fieldNI("extendedInterfaces"));
      t2 = _this.MethodsAwareness_methods;
      t3 = H._arrayInstanceType(t2);
      t4 = t3._eval$1("MappedListIterable<1,Map<String,@>>");
      return P.LinkedHashMap_LinkedHashMap$_literal(["name", _this.name, "extended_interfaces", t1, "access_modifiers", _this.AccessModifierAwareness_accessModifiers, "methods", P.List_List$of(new H.MappedListIterable(t2, t3._eval$1("Map<String,@>(1)")._as(new G.InterfaceModel_toJson_closure()), t4), true, t4._eval$1("ListIterable.E")), "type", "interface"], type$.String, type$.dynamic);
    }
  };
  G.InterfaceModel_toJson_closure.prototype = {
    call$1(e) {
      return type$.Method._as(e).toJson$0();
    },
    $signature: 10
  ...
  G.EnumModel.prototype = {
    ...
    toJson$0() {
      return P.LinkedHashMap_LinkedHashMap$_literal(["name", this.name, "access_modifiers", this.AccessModifierAwareness_accessModifiers, "type", "enum"], type$.String, type$.dynamic);
    }
  };
  ...
  F._allModifiers__sanitizeModifier.prototype = {
    call$1(modifier) {
      var sanitizedString;
      P.RangeError_checkValueInInterval(0, 0, modifier.length, "startIndex");
      sanitizedString = H.stringReplaceFirstUnchecked(modifier, "@", "", 0).toLowerCase();
  ...
  (function installTearOffs() {
    ...
    _static_1(P, "core__identityHashCode$closure", "identityHashCode", 33);
  ...
  (function inheritance() {
    ...
    _inheritMany(P.Iterable, [H._CastIterableBase, H.EfficientLengthIterable, H.MappedIterable, H.WhereIterable, H.SkipIterable, H.WhereTypeIterable, P.Runes, Q.ATNConfigSet]);
    ...
    _inheritMany(H.Closure, [H.Closure2Args, H.Closure0Args, H.TearOffClosure, H.JsLinkedHashMap_values_closure, H.initHooks_closure, H.initHooks_closure1, P._HashMap_values_closure, P._CustomHashMap_closure, P._CustomHashSet_closure, P._BigIntImpl_hashCode_finish, Q.ATNConfigSet_configLookup_closure0, A.ATNDeserializer_reset_closure, S.PredictionModeExtension_getConflictingAltSubsets_closure0, M.SemanticContext_filterNonPrecedencePredicates_closure, S.IntervalSet_toString_closure, U.main_closure, X.buildClass_closure, X.buildInterface_closure, F.Method_toJson_closure, F.Constructor_toJson_closure, G.ClassModel_toJson_closure, G.ClassModel_toJson_closure0, G.ClassModel_toJson_closure1, G.ClassModel_toJson_closure2, G.ClassModel_toJson_closure3, G.ClassModel_toJson_closure4, G.ClassModel_toJson_closure5, G.InterfaceModel_toJson_closure, E.ApexClassListener_enterFieldDeclaration_closure, E.ApexClassListener_enterFieldDeclaration_closure0, F.getAccessModifiers__hasNoVisibilityModifiers, F._allModifiers__sanitizeModifier, F._allModifiers_closure, A.parseParameters_closure, A.parseParameters__closure]);
    ...
    _inherit(R.ApexLexer, A.Lexer);
    _inherit(R.ApexParser, G.Parser);
    ...
    _inherit(K.ApexWalkerDefinition, K.WalkerDefinition);
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "ApexLexer__decisionToDFA", "$get$ApexLexer__decisionToDFA", function () {
      var i,
        ...
        _list = J.JSArray_JSArray$allocateGrowable(_length, H.findType("DFA"));
      for (i = 0; i < _length; ++i)
