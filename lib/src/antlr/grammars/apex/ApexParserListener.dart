...
abstract class ApexParserListener extends ParseTreeListener {
  ...
  /// Enter a parse tree produced by [ApexParser.ignoredBlock].
  /// [ctx] the parse tree
  void enterIgnoredBlock(IgnoredBlockContext ctx);
  /// Exit a parse tree produced by [ApexParser.ignoredBlock].
  /// [ctx] the parse tree
  void exitIgnoredBlock(IgnoredBlockContext ctx);

  /// Enter a parse tree produced by [ApexParser.ignoredBlockItem].
  /// [ctx] the parse tree
  void enterIgnoredBlockItem(IgnoredBlockItemContext ctx);
  /// Exit a parse tree produced by [ApexParser.ignoredBlockItem].
  /// [ctx] the parse tree
  void exitIgnoredBlockItem(IgnoredBlockItemContext ctx);
